...
public class VisitHourService {
    ...
    //TODO Dużo masz w aplikacji takich pokrętnych/skomplikowanych algorytów -> warto aby się skupić na ich czytelnością/poprawnością,
    //     może też napisać dla nich testy jednostkowe (spróbować?), bo będą bardzo ważne/atrakcyjne przy rekrutacji
